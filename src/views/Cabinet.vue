      ...
      <div v-else class="wrapper">
        <div class="home-content">
          <div class="home-block first">
            ...
            <div class="home-object">
              <div class="home-box">
                <p class="home-name">Имя</p>
              ...
              <div class="home-box">
                <p class="home-name">Дата рождения</p>
                <form class="home-input">
                  <div class="home-fix">
                    <label class="home-label">
                      <input class="home-input" type="text" placeholder="Введите" />
              ...
              <div class="home-box">
                <p class="home-name">Специализация</p>
                <form class="home-input">
                  <div class="home-fix">
                    <label class="home-label">
                      <input class="home-input" type="text" placeholder="Введите" />
