        ...
        <div class="container">
            ...
            <div class="prolect-material-checkbox-wrapper">
                <div class="prolect-material-checkbox">
                    <CheckboxSec @childClickSec="handleChildClickSec" v-for="item in store.state.sciences"
                        :key="item.title_ru" :item="item.title_ru" />
                </div>
            </div>
...
const author = ref("")
const region = ref([]) 
const youtube = ref("https://www.youtube.com/watch?v=Tcfm7SnGqDk") 
